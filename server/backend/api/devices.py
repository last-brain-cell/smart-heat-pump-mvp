...
def get_device_status(device_id: str):
    ...
    return DeviceStatusResponse(
        ...
        phase1_voltage=latest.get("phase1_voltage"),
        phase1_current=latest.get("phase1_current"),
        phase1_power=latest.get("phase1_power"),
        phase1_energy=latest.get("phase1_energy"),
        phase1_frequency=latest.get("phase1_frequency"),
        phase1_pf=latest.get("phase1_pf"),
        phase2_voltage=latest.get("phase2_voltage"),
        phase2_current=latest.get("phase2_current"),
        phase2_power=latest.get("phase2_power"),
        phase2_energy=latest.get("phase2_energy"),
        phase2_frequency=latest.get("phase2_frequency"),
        phase2_pf=latest.get("phase2_pf"),
        phase3_voltage=latest.get("phase3_voltage"),
        phase3_current=latest.get("phase3_current"),
        phase3_power=latest.get("phase3_power"),
        phase3_energy=latest.get("phase3_energy"),
        phase3_frequency=latest.get("phase3_frequency"),
        phase3_pf=latest.get("phase3_pf"),
    )
